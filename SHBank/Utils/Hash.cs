...
//        }
        ...
        public static bool CompareHashString(string inputPassword, string salt, string passwordHash)
        {
            return passwordHash.Equals(GenerateSaltedSHA1(inputPassword, salt));
        }
